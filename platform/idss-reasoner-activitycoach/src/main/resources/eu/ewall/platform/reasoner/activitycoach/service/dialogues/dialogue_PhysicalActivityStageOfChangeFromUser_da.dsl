...
step {
	stepId "Initial"
	statement "Alt du skal gøre, for at jeg kan opdatere dit forandringstrin, er at besvare et simpelt spørgsmål. Er du klar?"
	
	basicReply {
		replyId "A"
		statement "Ja, stil mig spørgsmålet."
		nextStepId "Question"
	}
	
	basicReply {
		replyId "B"
		statement "Kan du fortælle mig lidt mere om forandringstrin?"
...
step {
	stepId "Question"
	statement "Okay. Er du fysisk aktiv mindst fem gange hver uge (gang, cykling eller anden sport) i mere end 30 minutter hver gang?"

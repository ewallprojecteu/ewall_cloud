...
step {
	stepId "Initial"
	statement "Om uw Stadia van Gedragsverandering te updaten hoeft u alleen een simpele vraag te beantwoorden. Bent u er klaar voor?"
	
	basicReply {
		replyId "A"
		statement "Ja, stel de vraag maar."
		nextStepId "Question"
	}
	
	basicReply {
		replyId "B"
		statement "Kun je me iets meer vertellen over de Stadia van Gedragsverandering?"
...
step {
	stepId "Question"
	statement "Okee, daar gaat ie. Bent u minimaal 5 keer per week lichamelijk actief (wandelen, fietsen of sporten), gedurende minimaal 30 minuten per keer?"

...
step {
	stepId "Initial"
	statement "Hai un po' di tempo per parlare della tua attività fisica?"
	
	basicReply {
		replyId "A"
		statement "Certo, vai avanti."
		nextStepId "Question"
	}
	
	basicReply {
		replyId "B"
		statement "Qual è la domanda?"
		nextStepId "ExplanationOne"
	}
	
	basicReply {
		replyId "C"
		statement "Scusa, non adesso."
...
step {
	stepId "Question"
	statement "Sei fisicamente attivo (a piedi, in bicicletta o con qualche sport) almeno 5 volte a settimana e per più di mezz'ora ogni volta?"
...
step {
	...
	statement "Non preoccuparti, Proverò di nuovo domani."

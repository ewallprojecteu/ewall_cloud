...
public class DatabaseLoader {
	 ...
	 * @param mongoDbName the database name for ekitchen
	 */
	...
	/**
	 * Loads the database for ekitchen. It creates the database collections
	...
	public Database initDatabase(DatabaseConnection dbConn) throws DatabaseException {
		...
		tableDefs.add(new FridgeDataTable());
		tableDefs.add(new PantryDataTable());
		tableDefs.add(new ShoppingDataTable());

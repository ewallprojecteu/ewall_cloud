 ...
 * @author eandgrg
 */
public class UserWithVCardAndHealthSubprofilesToStringTest {
  ...
  public static void main(String[] args) {
    ...
    VCardSubProfile vCardSubProfile = new VCardSubProfile("somenickname", "someaddress",
        ...
        "somebirthplace", "some@Omail.com", VCardGenderType.MALE, "0038591123543", "00385123456",
    ...
    System.out.println(DM2JsonObjectMapper.writeValueAsString(user));

package eu.ewall.common.initialization.wadl;
...
/**
 * The Class WadlController.
 */
@Controller
@RequestMapping(value="/application.wadl", headers="Accept=*/*", method = RequestMethod.GET)
public class WadlController {
	 ...
	 *
	 * @param uri the uri
	 * @param wadResources the wad resources
	 * @return the resource
	 */

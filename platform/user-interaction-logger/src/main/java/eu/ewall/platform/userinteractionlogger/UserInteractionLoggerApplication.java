...
@PropertySource("classpath:/user-interaction-logger-${ewall.env:local}.properties")
@ComponentScan
public class UserInteractionLoggerApplication extends SpringBootServletInitializer {

	public UserInteractionLoggerApplication() {
	...
	protected SpringApplicationBuilder configure(
		...
		return application.sources(UserInteractionLoggerApplication.class);
	}

	public static void main(String[] args) {
		SpringApplication.run(UserInteractionLoggerApplication.class, args);
	}
}

...
(function (window, angular) {
    angular.module('language-picker', ['ui.bootstrap']).constant('langMap',
        window.languageMappingList).directive('languagePicker', ['$modal', 'langMap', function ($modal, langMap) {
            return {
                restrict: 'AE',
                transclude: true,
                scope: {
                ...
                replace: true,
                templateUrl: 'partials/language-picker/language-picker-button.html',
                link: function (scope, el, attrs, ctrl) {
                    ...
                    var modalTemplateUrl = 'partials/language-picker/language-picker-dialog.html';

...
var fusionerYoutubeLogin = angular.module('fusionerYoutubeLogin', []);

fusionerYoutubeLogin.controller('LoginController', ['$scope', '$state', '$http', 'localStorageService', 'REST_API', 'LoginHelper', 'locale',

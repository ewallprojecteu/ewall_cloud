...
var flickrPortalApplication = angular.module('flickrPortalApplication', ['language-picker']);

flickrPortalApplication.controller('ApplicationController', ['$scope', '$http', 'locale', 'localeSupported', 'localStorageService', 'REST_API',
    function ($scope, $http, locale, localeSupported, localStorageService, REST_API) {
        ...
        flickrPortalApplication.extractPreparingEnvironmentController($scope, hostname, pathname, protocol, REST_API);

...
public class FitBitMovement implements Serializable {
	...
	public FitBitMovement(DateTime from, DateTime to) {
		this(null, from, to);
	}
	
	@PersistenceConstructor
	public FitBitMovement(String username, DateTime from, DateTime to) {
	...
	public boolean equals(Object obj) {
		if (obj == this) {
			return true;
		} else if (obj == null || !(obj instanceof FitBitMovement)) {
			return false;
		}
		FitBitMovement other = (FitBitMovement) obj;

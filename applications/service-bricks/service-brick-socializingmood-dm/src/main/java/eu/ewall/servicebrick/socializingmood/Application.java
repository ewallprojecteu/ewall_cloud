package eu.ewall.servicebrick.socializingmood;
...
@PropertySource({"classpath:/service-brick-socializingmood-dm-${ewall.env:local}.properties","classpath:/key_words.properties"})
@ComponentScan
